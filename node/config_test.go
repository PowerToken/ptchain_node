...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gpt.ipc", false, filepath.Join(os.TempDir(), "gpt.ipc")},
		{"data", "gpt.ipc", false, "data/gpt.ipc"},
		{"data", "./gpt.ipc", false, "./gpt.ipc"},
		{"data", "/gpt.ipc", false, "/gpt.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gpt.ipc", true, `\\.\pipe\gpt.ipc`},
		{"data", "gpt.ipc", true, `\\.\pipe\gpt.ipc`},
		{"data", `\\.\pipe\gpt.ipc`, true, `\\.\pipe\gpt.ipc`},
	}
