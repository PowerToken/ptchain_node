...
type driver interface {
	...
	// Derive sends a derivation request to the USB device and returns the PowerToken
...
type wallet struct {
	...
	deriveChain     thundercore.ChainStateReader // Blockchain state reader to discover used account with
...
// chain state reader.
func (w *wallet) SelfDerive(bases []accounts.DerivationPath, chain thundercore.ChainStateReader) {
	w.stateLock.Lock()
	defer w.stateLock.Unlock()
