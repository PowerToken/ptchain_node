...
// Package bind generates PowerToken contract Go bindings.
//
// Detailed usage document and tutorial available on the ThunderCore Wiki page:
// https://github.com/PowerToken/ptchain_node/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
