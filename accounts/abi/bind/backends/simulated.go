...
import (
	...
	"github.com/PowerToken/ptchain_node"
	...
	"github.com/PowerToken/ptchain_node/common/hexutil"
	"github.com/PowerToken/ptchain_node/common/math"
	"github.com/PowerToken/ptchain_node/consensus/ethash"
	"github.com/PowerToken/ptchain_node/core"
	"github.com/PowerToken/ptchain_node/core/bloombits"
	"github.com/PowerToken/ptchain_node/core/rawdb"
	"github.com/PowerToken/ptchain_node/core/state"
	"github.com/PowerToken/ptchain_node/core/types"
	"github.com/PowerToken/ptchain_node/core/vm"
	"github.com/PowerToken/ptchain_node/pt/filters"
	...
	"github.com/PowerToken/ptchain_node/rpc"
)
...
type SimulatedBackend struct {
	...
	blockchain *core.BlockChain // PowerToken blockchain to handle the consensus
...
func (b *SimulatedBackend) TransactionByHash(_ context.Context, txHash common.Hash) (*types.Transaction, bool, error) {
	...
	return nil, false, thundercore.NotFound
}
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call thundercore.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call thundercore.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call thundercore.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(_ context.Context, call thundercore.CallMsg, block *types.Block, stateDB *state.StateDB) (*core.ExecutionResult, error) {
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query thundercore.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(_ context.Context, query thundercore.FilterQuery, ch chan<- types.Log) (thundercore.Subscription, error) {
...
func (b *SimulatedBackend) SubscribeNewHead(_ context.Context, ch chan<- *types.Header) (thundercore.Subscription, error) {
