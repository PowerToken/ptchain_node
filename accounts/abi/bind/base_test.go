...
func (mc *mockCaller) CallContract(ctx context.Context, call thundercore.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call thundercore.CallMsg) ([]byte, error) {
