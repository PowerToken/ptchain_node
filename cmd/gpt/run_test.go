...
import (
	...
	"github.com/PowerToken/ptchain_node/internal/cmdtest"
	"github.com/PowerToken/ptchain_node/rpc"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "gpt-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "gpt-test" in runGeth.
	reexec.Register("gpt-test", func() {
...
// spawns gpt with the given command line args. If the args don't set --datadir, the
...
func runGeth(t *testing.T, args ...string) *testgeth {
	...
	// Boot "gpt". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("gpt-test", args...)
