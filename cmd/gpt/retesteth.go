...
import (
	...
	"github.com/PowerToken/ptchain_node/consensus/misc"
	...
	"github.com/PowerToken/ptchain_node/trie"
...
var (
	...
	retestethCommand = cli.Command{
		...
		Name:        "retesteth",
		Usage:       "Launches gpt in retesteth mode",
		ArgsUsage:   "",
		Flags:       []cli.Flag{rpcPortFlag},
		Category:    "MISCELLANEOUS COMMANDS",
		Description: `Launches gpt in retesteth mode (no database, no network, only retesteth RPC interface)`,
	}
)
