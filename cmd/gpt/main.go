...
// gpt is the official command-line client for ThunderCore.
package main
...
import (
	...
	"github.com/PowerToken/ptchain_node/console/prompt"
	"github.com/PowerToken/ptchain_node/pt"
	"github.com/PowerToken/ptchain_node/pt/downloader"
	"github.com/PowerToken/ptchain_node/ptclient"
	"github.com/PowerToken/ptchain_node/internal/debug"
...
const (
	clientIdentifier = "gpt" // Client identifier to advertise over the network
)
...
var (
	...
	app = flags.NewApp(gitCommit, gitDate, "the ThunderCore command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2013-2020 The ThunderCore Authors"
...
// gpt is the main entry point into the system if no special subcommand is ran.
// It creates a default node based on the command line arguments and runs it in
// blocking mode, waiting for it to be shut down.
func gpt(ctx *cli.Context) error {
...
func startNode(ctx *cli.Context, stack *node.Node, backend ethapi.Backend) {
	...
	// Create a client to interact with local gpt node.
