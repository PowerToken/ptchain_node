...
// Package utils contains internal helper functions for ThunderCore commands.
package utils
...
import (
	...
	"github.com/PowerToken/ptchain_node/accounts"
	"github.com/PowerToken/ptchain_node/accounts/keystore"
	"github.com/PowerToken/ptchain_node/common"
	"github.com/PowerToken/ptchain_node/common/fdlimit"
	"github.com/PowerToken/ptchain_node/consensus"
	"github.com/PowerToken/ptchain_node/consensus/clique"
	...
	"github.com/PowerToken/ptchain_node/crypto"
	"github.com/PowerToken/ptchain_node/pt"
	"github.com/PowerToken/ptchain_node/pt/downloader"
	"github.com/PowerToken/ptchain_node/pt/gasprice"
	"github.com/PowerToken/ptchain_node/ptdb"
	"github.com/PowerToken/ptchain_node/ptstats"
	"github.com/PowerToken/ptchain_node/graphql"
	"github.com/PowerToken/ptchain_node/internal/ethapi"
	"github.com/PowerToken/ptchain_node/internal/flags"
	"github.com/PowerToken/ptchain_node/les"
	"github.com/PowerToken/ptchain_node/log"
	"github.com/PowerToken/ptchain_node/metrics"
	"github.com/PowerToken/ptchain_node/metrics/exp"
	"github.com/PowerToken/ptchain_node/metrics/influxdb"
	"github.com/PowerToken/ptchain_node/miner"
	"github.com/PowerToken/ptchain_node/node"
	"github.com/PowerToken/ptchain_node/p2p"
	"github.com/PowerToken/ptchain_node/p2p/discv5"
	"github.com/PowerToken/ptchain_node/p2p/enode"
	"github.com/PowerToken/ptchain_node/p2p/nat"
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `gpt account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "gpt.", tagsMap)
		}
...
// new format.
//
// e.g. gpt account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// gpt --keystore /tmp/mykeystore --lightkdf account new
//
